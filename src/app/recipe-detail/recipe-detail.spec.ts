...
describe('RecipeDetailComponent', () => {
    ...
    it('should display the recipe details when a recipe is found', () => {
        ...
        expect(compiled.querySelector('.recipe-detail__badge')?.textContent).toContain(mockRecipe.category);
        ...
        expect(compiled.querySelector('.recipe-detail__instructions')?.textContent).toBe(mockRecipe.instructions);
    });
    ...
    it('should show the empty state when no recipe is found', () => {
        ...
        expect(compiled.querySelector('.recipe-detail__empty')?.textContent).toContain('Selecciona una receta');
    });
    ...
    it('should update the recipe when the id in the params changes', () => {
        ...
        function compiled() { return fixture.nativeElement as HTMLElement; }
    });
});
